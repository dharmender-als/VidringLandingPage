...
public class VidringLpService {
	...
	public String getLandingPage(String operatorId, String countryCode, String userAgent, String alias, String kpId,
			Model model, String msisdn) {
		...
		if (Boolean.TRUE.equals(Objects.nonNull(advertizerModel)) || alias.equalsIgnoreCase("0")) {
			dbUtils.saveTransaction(operatorId, countryCode, userAgent, alias, kpId, model, msisdn);
